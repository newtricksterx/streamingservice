...
public class Library {
    ...
    private Library(String pLibraryName, String pLibraryDescription){
        ...
        DefaultPlayable.createDefaultPlayable(null);
    }
    ...
    /**
     * gets the playable that represents the default playable
     * @return a playable
     */
    public DefaultPlayable getDefaultPlayable() {
        return DefaultPlayable.getDefaultPlayable();
    }

    /**
     * sets the default playable of the library
     * @param p
     *          the playable that the user wants the default playable to be
     */
    public void setDefaultPlayable(Playable p){
        DefaultPlayable.setDefaultPlayable(p);
    }
